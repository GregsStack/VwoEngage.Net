namespace GregsStack.VwoEngage.Net.Api.Request
{
    using System;
    ...
    public class ScheduleMessageRequest
    {
        ...
        /// <summary>
        /// This is an integer used to denote that this notification needs to be scheduled.
        /// To be sent as '1'.
        /// </summary>
        public bool Schedule { get; set; }

        /// <summary>
        /// The date on which the scheduled notification should go out.
        /// Should be in YYYY-MM-DD format.
        /// </summary>
        public DateTime Date { get; set; }

        /// <summary>
        /// The time on which the scheduled notification should go out.
        /// This needs to be according to UTC/GMT timezone.
        /// Format: HH:mm:SS
        /// </summary>
